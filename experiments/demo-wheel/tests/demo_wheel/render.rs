...
pub(super) fn render_report(metrics: &Metrics, flow_graph: &FlowGraph) -> String {
    format!(
        ...
        serde_json::to_string_pretty(&metrics.real_planner_checks).unwrap_or_default(),
