...
pub use hnsw_build::{HnswBuildReport, HnswBuildSettings, create_hnsw_index, drop_hnsw_index};
pub use jobs::{
    claim_pending_embedding_jobs, complete_embedding_job, complete_embedding_jobs,
    ...
    list_facts_missing_embedding, release_embedding_jobs,
};
pub(crate) use jobs::{enqueue_embedding_job_in_tx, enqueue_embedding_jobs_in_tx};
...
pub(crate) use write::{
    insert_embedding, insert_embedding_chunks, insert_memory_embedding, insert_memory_embeddings,
};
