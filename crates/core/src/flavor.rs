    ...
    pub fn add_fact_schema<F: FactPayload>(&mut self) {
        self.register_schema(
            SchemaInfo {
                ...
                protocol_ingress: Some(ingest_fact_payload::<F>),
    ...
    pub fn add_abstraction_schema<A: AbstractionPayload>(&mut self) {
        self.register_schema(
            SchemaInfo {
                ...
                tombstone: None,
                protocol_ingress: Some(ingest_abstraction_payload::<A>),
                cited_object_schema: None,
            },
            A::search_projection(),
    ...
    pub fn add_perspective_schema<P: PerspectivePayload>(&mut self) {
        self.register_schema(
            SchemaInfo {
                ...
                natural_key_columns: vec![],
                tombstone: None,
                protocol_ingress: Some(ingest_perspective_payload::<P>),
                cited_object_schema: None,
            },
            P::search_projection(),
    ...
    pub fn add_goal_schema<G: GoalPayload>(&mut self) {
        ...
        self.register_schema(
            SchemaInfo {
                ...
                natural_key_columns: vec![],
                tombstone: None,
                protocol_ingress: Some(ingest_goal_payload::<G>),
                cited_object_schema: None,
            },
            None,
    ...
    pub fn add_edge_schema<E: EdgePayload>(&mut self) {
        self.register_schema(
            SchemaInfo {
                ...
                natural_key_columns: vec![],
                tombstone: None,
                protocol_ingress: Some(ingest_edge_payload::<E>),
                cited_object_schema: None,
            },
            None,
    ...
    pub fn add_cited_object_schema<C: CitedObjectPayload>(&mut self) {
        self.register_schema(
            SchemaInfo {
                ...
                natural_key_columns: vec![],
                tombstone: None,
                protocol_ingress: Some(ingest_cited_object_payload::<C>),
                cited_object_schema: None,
            },
            None,
    ...
    pub fn add_citation_mapping_schema<M: CitationMappingPayload>(&mut self) {
        self.register_schema(
            SchemaInfo {
                ...
                natural_key_columns: vec![],
                tombstone: None,
                protocol_ingress: Some(ingest_citation_mapping_payload::<M>),
