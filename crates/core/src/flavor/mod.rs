...
pub use contract::{
    ...
    BespokeEraseLeg, CORE_ORDINAL, DEFAULT_RANK_WEIGHTS, DbConstraint, DbTrigger, EmbedText,
    EmbedUnit, EmbeddingRecipe, EmbeddingSlot, Enforcement, EraseLeg, EraseRule, ExportRule,
    FlavorContract, ForgetRule, KeyShape, LanguagePolicy, PROJECTION_MEMORY_FK,
