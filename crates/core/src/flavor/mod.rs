...
pub use contract::{
    ...
    ForgetRule, HostStateEraseDisposition, KeyShape, LanguagePolicy, PROJECTION_MEMORY_COLUMN,
    PROJECTION_MEMORY_FK, PROJECTION_TABLE_NAME, ProjectionDecl, ProjectionSpec, Provenance,
    RankSource, ResolvedEmbedUnit, ResourceContract, SLOT_DEFAULT, SchemaContract, SchemaRef,
