...
pub use contract::{
    ...
    EmbeddingSlot, Enforcement, EraseLeg, EraseRule, ExportRule, FlavorContract, ForgetRule,
    KeyShape, LanguagePolicy, PROJECTION_MEMORY_FK, PROJECTION_TABLE_NAME, ProjectionDecl,
