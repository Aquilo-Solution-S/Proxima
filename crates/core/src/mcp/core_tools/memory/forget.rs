...
impl McpTool for ForgetTool {
    ...
    const DESCRIPTION: &'static str =
        "Cool one memory t: PUT cold object, delete hot row, announce.forget. ingest_keys stay. Refuses if a remaining hot non-Fact would lose its last hot pin / cooled-Fact leaf.";
