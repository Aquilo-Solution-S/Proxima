...
| MCP auth rejected | bearer token, OIDC subject map, or owner selection mismatch | use a valid OIDC bearer and `X-Proxima-Owner: personal:<user-id>` / `group:<uuid>` / `world` |
