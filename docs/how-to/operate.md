...
|---|---|---|
| `ProximaError::V004ResetRequired` / `EmbedError::V004ResetRequired` | ledger checksum or schema objects do not match `0001_v008.sql` | export if needed, then reset the DB. Never in-place ALTER |
