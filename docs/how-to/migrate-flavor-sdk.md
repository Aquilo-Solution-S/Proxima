...
Pin all Proxima Rust dependencies to the same `v0.0.19` tag. Hand-written
...
| Surface | Upgrade |
|---|---|
| Database | Core `0018_v019_owner_rls_installer.sql` adds `proxima_core.install_owner_rls`; code flavor `20260924000020_v019_owner_rls_installer.sql` re-installs its policies through it. Existing databases upgrade in place. |
